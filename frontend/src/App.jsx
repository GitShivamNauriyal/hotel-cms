...
export default function App() {
    ...
    const renderContent = () => {
        ...
        switch (activeTab) {
            case "rooms":
                return <RoomGrid userRole={userRole} rooms={rooms} roomTypes={roomTypes} reservations={reservations} triggerSync={triggerSync} setActiveTab={setActiveTab} />
            case "stay":
                return <StayViewPage userRole={userRole} rooms={rooms} reservations={reservations} triggerSync={triggerSync} />
            case "checkins":
                return <CheckinsPage userRole={userRole} reservations={reservations} rooms={rooms} triggerSync={triggerSync} setActiveTab={setActiveTab} />
            case "reservations":
                return (
                    <ReservationsPage
