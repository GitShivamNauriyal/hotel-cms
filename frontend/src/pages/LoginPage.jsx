                    ...
                    <div className="relative z-10 space-y-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <motion.button
                                ...
                                type="submit"
                                disabled={isLoading}
                                className="w-full py-4 px-4 bg-brand hover:bg-brand/90 text-[var(--brand-text)] rounded-2xl font-bold flex items-center justify-center gap-2 transition-colors disabled:opacity-70 disabled:cursor-not-allowed shadow-[0_8px_20px_-8px_rgba(37,99,235,0.5)]"
                            >
                                {isLoading ? (
                                    <div className="w-5 h-5 border-2 text-[var(--brand-text)] border-app-bg/30 border-t-app-bg rounded-full animate-spin" />
                                ) : (
                                    <>
                                        Sign In
