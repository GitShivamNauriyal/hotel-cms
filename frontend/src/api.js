...
export const api = {
    ...
    updateReservationDetails: (id, data) => fetch(`${BASE_URL}/reservations/${id}`, { method: 'PUT', headers: getAuthHeaders(), body: JSON.stringify(data) }).then(handleResponse),
    reassignReservation: (id, data) => fetch(`${BASE_URL}/reservations/${id}/reassign`, { method: 'PUT', headers: getAuthHeaders(), body: JSON.stringify(data) }).then(handleResponse),
